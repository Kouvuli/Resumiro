...
drop table resume_allowed_user cascade;
drop type "roles";
drop type "statuses";
CREATE TYPE roles AS ENUM ('candidate', 'recruiter','admin');

CREATE TYPE statuses AS ENUM ('pending','rejected','verified');
...
create table resume_allowed_user(
	user_id int,
	resume_id int,
	CONSTRAINT pk_user_resume PRIMARY KEY(user_id,resume_id)
);
